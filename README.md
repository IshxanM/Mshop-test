...
Серверная часть была реализована на фреймворке [Express js](https://expressjs.com/ru/). В качестве БД использовал [PostgreSQL 15](https://www.postgresql.org/)

Интернет-магазин состоит из клиентской и административной частей. Была реализована функция Регистрации/Авторизации.
_____
...
Далее необходимо нажать правой кнопкой мыши на ранее созданной БД и выбрать пункт "Restore"

<img alt="Клиентская часть" src="https://github.com/IshxanM/Mshop-test/blob/main/БД/assets/import.png" width="300"/>.

Далее необходимо выбрать формат "Custom or tar", в поле "Filename" необходимо нажать на иконку папки, затем выбрать директорию с проектом, в папке БД нажать "Все файлы *" и выбрать файл "BD_Mshop", нажать на кнопку "Restore"
...
____
*DB_PASSWORD это пароль, который вы вводили при установке pgAdmin. В моём случае это "admin".
____
```
PORT= 3002
DB_NAME=Mshop
